...
class VisionTransformer(nn.Module):
    def __init__(self, config, img_size=224, num_classes=21843, smoothing_value=0, zero_head=False, class_weights_path=None):
        ...
        if class_weights_path is not None:
            self.class_weights = torch.load(class_weights_path)
